...
namespace MISA.eShop.DataLayer.Base
{
    /// <summary>
    ...
    public class BaseDL<T>: IBaseDL<T> where T: class
    {
        ...
        {
            var storeName = MISAProc.PRE_PROC_NAME + MISAProc.PROC_GET_ALL + typeof(T).Name;
        ...
        {
            var storeName = MISAProc.PRE_PROC_NAME + MISAProc.PROC_GET + typeof(T).Name + MISAProc.LAST_GET_BYID;
        ...
        {
            var storeName = MISAProc.PRE_PROC_NAME + MISAProc.PROC_GET + typeof(T).Name + MISAProc.LAST_GET_BYSKU;
        ...
        {
            var storeName = MISAProc.PRE_PROC_NAME + MISAProc.PROC_GET + typeof(T).Name + MISAProc.LAST_GET_BYCODE;
        ...
        {
            var storeName = MISAProc.PRE_PROC_NAME + MISAProc.PROC_INSERT + typeof(T).Name;
        ...
        {
            var storeName = MISAProc.PRE_PROC_NAME + MISAProc.PROC_UPDATE + typeof(T).Name;
            var result = _dbContext.ExcuteStore(storeName, entity);
        ...
        {
            var storeName = MISAProc.PRE_PROC_NAME + MISAProc.PROC_DELETE + typeof(T).Name;
